...
import { useSheetAlumni } from '../hooks/useSheetAlumni.js'

export default function Alumni() {
  const [active, setActive] = useState('all')
  const { destinations, loading, error } = useSheetAlumni()
  ...
  return (
    <>
      ...
      <Container className="py-10">
        <SheetStatusBanner error={error} resourceLabel="alumni destinations" />
