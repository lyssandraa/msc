...
import { useSheetCommittee } from '../hooks/useSheetCommittee.js'

export default function Committee() {
  const { committee, sectorTeams, loading, error } = useSheetCommittee()
  ...
  return (
    <>
      ...
      <Container className="py-12">
        <SheetStatusBanner error={error} resourceLabel="the committee" />
